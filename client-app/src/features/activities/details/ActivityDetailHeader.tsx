      ...
      <Segment basic attached="top" style={{ padding: "0" }}>
        {
          ...
          <Label style={{position:'absolute',zIndex:1000,left:-14,top:20}} content="Cancelled" color="red" ribbon></Label>
        }
        <Image
      ...
      <Segment clearing attached="bottom">
        {activity.isHost  ? (
          <>
            ...
            <Button loading={loading} onClick={cancelActivityToggle}>
             {activity.isCancelled?"Reactive":"Cancel Activity"} 
            </Button>
          </>
        )  : activity.isGoing ? (
